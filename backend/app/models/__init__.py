...
class MonitoringSetting(Base):
    ...
    poll_online_min: Mapped[float] = mapped_column(Float, default=5.0, nullable=False)
    poll_online_max: Mapped[float] = mapped_column(Float, default=10.0, nullable=False)
